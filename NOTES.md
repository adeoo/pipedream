...
- Lesson 0001 (frame anatomy) delivered 2026-09-01. Quiz results not yet observed —
  ...
  questions in chat.
- Next lesson candidates: reading a geometry chart (use a real touring bike, e.g.
  a Surly Long Haul Trucker chart); then wheelbase/trail intuition.
- Glossary not started yet — wait until anatomy terms are demonstrated, then seed
  it with the eight frame parts.
